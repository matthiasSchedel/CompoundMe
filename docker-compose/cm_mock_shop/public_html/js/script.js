...
function createArticleHtml(article) {
  return (
    // prettier-ignore
    "<div class='col-sm-4' style='background:#f4f6f7'>" +
        "<div class='card' style='width: 22rem; margin: 5px auto; align-item: center;'>" +
            "<div class='card-body'>" +
                "<h3 class='display-4' style='font-size: 2.5rem;'> " +
                article.name +
                "</h3>" +
                ...
                "<div style='margin: auto 0; float: right;'>" +
                    ...
                    article.id +
                    "' type='number' value='0' style='width: 100px;'>  </input>" +
                "</div>" +
            "</div>" +
        "</div>" +
    "</div>"
